...
Присвой описание "жалоба на менеджера" только тем текстам, в которых клиент явно ссылается на конкретного человека, например, "наш персональный менеджер опять не отвечает на звонки..." или "оператора Иван Иванов некомпетентен..."
, то есть из жалобы можно четко понять, кто является виновником проблемы.
